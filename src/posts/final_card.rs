...
impl Display for FinalCard {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        let Self { score, standings, record_text, record, next_game, pitching_masterpiece, linescore: line_score, scoring_plays, decisions } = self;
        ...
        if let Some(pitching_masterpiece) = &pitching_masterpiece {
